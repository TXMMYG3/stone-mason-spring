    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <img
          ...
          alt="Luxury Pool and Garden Design"
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            Creating extraordinary outdoor living spaces with over 30 years of expertise. 
            From luxury pools to stunning gardens, we bring your vision to life.
          </motion.p>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row justify-center items-center gap-6 text-gray-400"
          >
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-sm">800+ Projects Completed</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            ...
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
              <span className="text-sm">Featured on HGTV</span>
            </div>
          </motion.div>
        </motion.div>
      </div>
